...
const Page = () => {
 ...
 <section id='vision' className='hidden sm:block min-h-screen bg-gradient-to-br from-slate-950 via-gray-900 to-stone-900 relative overflow-hidden'>
 ...
 <section className='min-h-screen bg-gradient-to-br from-slate-950 via-gray-900 to-stone-900 py-12 sm:py-16 lg:py-20' id='upcoming'>
  <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
    {/* Premium Section Header */}
    <div className='text-center mb-12 sm:mb-16'>
      <div className='w-16 sm:w-20 h-0.5 bg-gradient-to-r from-amber-400 via-yellow-300 to-amber-500 mx-auto mb-6 sm:mb-8'></div>
      <h1 className='font-display text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-light text-white tracking-tight leading-none mb-4 sm:mb-6'>
        <span className='text-gradient-gold font-bold'>UPCOMING</span>
        <br />
        <span className='font-heading font-extralight text-gray-300 text-xl sm:text-2xl md:text-3xl lg:text-5xl tracking-[0.15em] uppercase'>
          PROJECTS
        </span>
      </h1>
      <p className='font-body text-gray-300 text-base sm:text-lg lg:text-xl leading-relaxed max-w-2xl mx-auto px-4'>
    ...
    <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16'>
      ...
      <div className='group relative'>
        <div className='glass-premium border border-amber-500/10 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12 shadow-premium hover:shadow-gold transition-all duration-500 hover:border-amber-500/20'>
          <div className='flex flex-col lg:flex-row items-center gap-6 sm:gap-8'>
            <div className='w-full lg:w-1/2'>
              <div className='bg-gradient-to-br from-slate-800 to-gray-800 rounded-xl sm:rounded-2xl p-4 sm:p-6 h-48 sm:h-64 flex items-center justify-center border border-amber-500/10'>
                <A />
              </div>
            </div>
            <div className='w-full lg:w-1/2 space-y-4 sm:space-y-6'>
              <div>
                <div className='flex items-center gap-3 sm:gap-4 mb-3 sm:mb-4'>
                  <div className='w-8 sm:w-12 h-0.5 bg-gradient-to-r from-amber-400 to-amber-500'></div>
                  <span className='font-heading text-amber-400 text-xs sm:text-sm uppercase tracking-wider'>Project Alpha</span>
                </div>
                <h3 className='font-display text-2xl sm:text-3xl lg:text-4xl font-bold text-gradient-gold mb-3 sm:mb-4'>
                  Modern Residential Tower
                </h3>
                <p className='font-body text-gray-300 leading-relaxed text-sm sm:text-base mb-4 sm:mb-6'>
              ...
              <div className='flex flex-wrap gap-3 sm:gap-4'>
                <div className='glass-gold px-3 sm:px-4 py-2 rounded-lg'>
                  <span className='font-heading text-amber-200 text-xs sm:text-sm uppercase tracking-wider'>30 Floors</span>
                </div>
                <div className='glass-gold px-3 sm:px-4 py-2 rounded-lg'>
                  <span className='font-heading text-amber-200 text-xs sm:text-sm uppercase tracking-wider'>Luxury Units</span>
                </div>
                <div className='glass-gold px-3 sm:px-4 py-2 rounded-lg'>
                  <span className='font-heading text-amber-200 text-xs sm:text-sm uppercase tracking-wider'>2024</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className='flex flex-col lg:flex-row items-center gap-6 sm:gap-8'>
            <div className='w-full lg:w-1/2 order-2 lg:order-1 space-y-4 sm:space-y-6'>
              <div>
                <div className='flex items-center gap-3 sm:gap-4 mb-3 sm:mb-4'>
                  <div className='w-8 sm:w-12 h-0.5 bg-gradient-to-r from-amber-400 to-amber-500'></div>
                  <span className='font-heading text-amber-400 text-xs sm:text-sm uppercase tracking-wider'>Project Beta</span>
                </div>
                <h3 className='font-display text-2xl sm:text-3xl lg:text-4xl font-bold text-gradient-gold mb-3 sm:mb-4'>
                  Commercial Complex
                </h3>
              ...
              <div className='flex flex-wrap gap-3 sm:gap-4'>
                <div className='glass-gold px-3 sm:px-4 py-2 rounded-lg'>
                  <span className='font-heading text-amber-200 text-xs sm:text-sm uppercase tracking-wider'>25 Floors</span>
                </div>
                <div className='glass-gold px-3 sm:px-4 py-2 rounded-lg'>
                  <span className='font-heading text-amber-200 text-xs sm:text-sm uppercase tracking-wider'>Mixed Use</span>
                </div>
                <div className='glass-gold px-3 sm:px-4 py-2 rounded-lg'>
                  <span className='font-heading text-amber-200 text-xs sm:text-sm uppercase tracking-wider'>2025</span>
                </div>
              </div>
            </div>
    ...
    <div className='text-center mt-12 sm:mt-16 lg:mt-20'>
      <div className='glass-premium border border-amber-500/10 rounded-xl sm:rounded-2xl p-6 sm:p-8 lg:p-12 shadow-premium'>
        <h3 className='font-display text-xl sm:text-2xl lg:text-3xl font-bold text-gradient-gold mb-4 sm:mb-6'>
          Interested in Our Upcoming Projects?
        </h3>
        <p className='font-body text-gray-300 text-base sm:text-lg mb-6 sm:mb-8 max-w-2xl mx-auto px-4'>
        ...
        <a 
          ...
          className='w-full sm:w-auto inline-flex items-center justify-center gap-3 btn-premium font-heading px-6 sm:px-8 py-3 sm:py-4 text-sm sm:text-base border border-amber-500/20 focus-premium'
        >
 ...
 <section className='min-h-screen bg-gradient-to-br from-slate-950 via-gray-900 to-stone-900 py-12 sm:py-16 lg:py-20' id='layout'>
   <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
     {/* Premium Section Header */}
     <div className='text-center mb-12 sm:mb-16'>
       <div className='w-16 sm:w-20 h-0.5 bg-gradient-to-r from-amber-400 via-yellow-300 to-amber-500 mx-auto mb-6 sm:mb-8'></div>
     ...
     <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center'>
       ...
       <div className='order-2 lg:order-1'>
         <div className='glass-premium border border-amber-500/10 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12 shadow-premium'>
           <div className='space-y-6 sm:space-y-8'>
             <div>
               <div className='flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6'>
                 <div className='w-8 sm:w-12 h-0.5 bg-gradient-to-r from-amber-400 to-amber-500'></div>
                 <span className='font-heading text-amber-400 text-xs sm:text-sm uppercase tracking-wider'>Premium Living</span>
               </div>
               <h2 className='font-display text-2xl sm:text-3xl lg:text-4xl font-bold text-gradient-gold mb-4 sm:mb-6'>
                 Luxury Interior Design
               </h2>
               <p className='font-body text-gray-300 leading-relaxed text-base sm:text-lg mb-6 sm:mb-8'>
             ...
             <div className='pt-4 sm:pt-6'>
               <a 
                 href='https://wa.me/+919850455290' 
                 className='w-full sm:w-auto inline-flex items-center justify-center gap-3 btn-premium font-heading px-6 py-3 text-sm border border-amber-500/20 focus-premium'
               >
       ...
       <div className='order-1 lg:order-2'>
         <div className='glass-premium border border-amber-500/10 rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-premium'>
           <div className='bg-gradient-to-br from-slate-800 to-gray-800 rounded-xl sm:rounded-2xl h-64 sm:h-80 md:h-96 lg:h-[500px] border border-amber-500/10 relative overflow-hidden'>
             {/* 3D Model takes full container */}
             <In/>
             
             {/* Floating title overlay */}
             <div className='absolute top-3 sm:top-4 left-3 sm:left-4 glass-gold px-3 sm:px-4 py-2 rounded-lg z-10'>
               <h3 className='font-display text-base sm:text-lg text-gradient-gold font-semibold'>3D Interior Preview</h3>
               <p className='font-body text-gray-400 text-xs hidden sm:block'>Interactive layout visualization</p>
             </div>
           </div>
         </div>
       </div>
 ...
 <section className='min-h-screen bg-gradient-to-br from-slate-950 via-gray-900 to-stone-900 py-12 sm:py-16 lg:py-20' id='details'>
   <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
     {/* Premium Section Header */}
     <div className='text-center mb-12 sm:mb-16'>
       <div className='w-16 sm:w-20 h-0.5 bg-gradient-to-r from-amber-400 via-yellow-300 to-amber-500 mx-auto mb-6 sm:mb-8'></div>
     ...
     <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 mb-12 sm:mb-16'>
       ...
       <div className='glass-premium border border-amber-500/10 rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-premium'>
         <div className='mb-4 sm:mb-6'>
           <div className='flex items-center gap-3 sm:gap-4 mb-3 sm:mb-4'>
             <div className='w-8 sm:w-12 h-0.5 bg-gradient-to-r from-amber-400 to-amber-500'></div>
             <span className='font-heading text-amber-400 text-xs sm:text-sm uppercase tracking-wider'>Location</span>
           </div>
           <h3 className='font-display text-xl sm:text-2xl lg:text-3xl font-bold text-gradient-gold mb-3 sm:mb-4'>
             Prime Location Map
           </h3>
           <p className='font-body text-gray-300 leading-relaxed text-sm sm:text-base mb-4 sm:mb-6'>
         ...
         <div className='bg-gradient-to-br from-slate-800 to-gray-800 rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-amber-500/10 h-48 sm:h-64 lg:h-80 flex items-center justify-center'>
           <Map/>
         </div>
       ...
       <div className='glass-premium border border-amber-500/10 rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-premium'>
         <div className='mb-4 sm:mb-6'>
           <div className='flex items-center gap-3 sm:gap-4 mb-3 sm:mb-4'>
             <div className='w-8 sm:w-12 h-0.5 bg-gradient-to-r from-amber-400 to-amber-500'></div>
             <span className='font-heading text-amber-400 text-xs sm:text-sm uppercase tracking-wider'>Gallery</span>
           </div>
           <h3 className='font-display text-xl sm:text-2xl lg:text-3xl font-bold text-gradient-gold mb-3 sm:mb-4'>
             Project Showcase
           </h3>
         ...
         <div className='bg-gradient-to-br from-slate-800 to-gray-800 rounded-xl sm:rounded-2xl p-3 sm:p-4 border border-amber-500/10'>
           <Carousel1 />
         </div>

         {/* Gallery Stats */}
         <div className='grid grid-cols-3 gap-3 sm:gap-4 mt-4 sm:mt-6'>
           <div className='glass-gold p-2 sm:p-3 rounded-lg text-center'>
             <h4 className='font-display text-base sm:text-lg text-gradient-gold font-bold'>25+</h4>
             <p className='font-body text-gray-300 text-xs'>Photos</p>
           </div>
           <div className='glass-gold p-2 sm:p-3 rounded-lg text-center'>
             <h4 className='font-display text-base sm:text-lg text-gradient-gold font-bold'>4K</h4>
             <p className='font-body text-gray-300 text-xs'>Resolution</p>
           </div>
           <div className='glass-gold p-2 sm:p-3 rounded-lg text-center'>
             <h4 className='font-display text-base sm:text-lg text-gradient-gold font-bold'>360°</h4>
       ...
       <div className='grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8 items-start lg:items-center'>
         ...
         <div className='lg:col-span-2 space-y-4 sm:space-y-6'>
           <div>
             <div className='flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6'>
               <div className='w-8 sm:w-12 h-0.5 bg-gradient-to-r from-amber-400 to-amber-500'></div>
               <span className='font-heading text-amber-400 text-xs sm:text-sm uppercase tracking-wider'>Investment Opportunity</span>
             </div>
             <h3 className='font-display text-2xl sm:text-3xl lg:text-4xl font-bold text-gradient-gold mb-4 sm:mb-6'>
         ...
         <div className='lg:col-span-1 mt-6 lg:mt-0'>
           <div className='glass-gold border border-amber-500/20 rounded-xl sm:rounded-2xl p-6 sm:p-8 text-center shadow-gold'>
             <div className='mb-4 sm:mb-6'>
               <span className='font-heading text-amber-200 text-xs sm:text-sm uppercase tracking-wider block mb-2'>Starting Price</span>
               <div className='font-display text-3xl sm:text-4xl lg:text-5xl font-bold text-gradient-gold mb-2'>
                 ₹80L
               </div>
               <p className='font-body text-gray-300 text-xs sm:text-sm'>*Inclusive of all taxes</p>
             </div>

             <div className='space-y-3 sm:space-y-4 mb-6 sm:mb-8'>
               <div className='flex justify-between items-center'>
                 <span className='font-body text-gray-300 text-xs sm:text-sm'>Base Price</span>
                 <span className='font-heading text-amber-200 text-xs sm:text-sm'>₹1cr</span>
               </div>
               <div className='flex justify-between items-center'>
                 <span className='font-body text-gray-300 text-xs sm:text-sm'>Registration</span>
                 <span className='font-heading text-amber-200 text-xs sm:text-sm'>₹10L</span>
               </div>
               <div className='flex justify-between items-center'>
                 <span className='font-body text-gray-300 text-xs sm:text-sm'>Other Charges</span>
                 <span className='font-heading text-amber-200 text-xs sm:text-sm'>₹10L</span>
               </div>
               <div className='w-full h-px bg-amber-500/20'></div>
               <div className='flex justify-between items-center'>
                 <span className='font-heading text-amber-200 font-semibold text-sm sm:text-base'>Total</span>
                 <span className='font-display text-lg sm:text-xl text-gradient-gold font-bold'>₹1.2Cr</span>
               </div>
             </div>
